...
# Initialize wandb
wandb.init(project="emoreact_girls_4fc", entity="dtat-universitat-oberta-de-catalunya")
...
def manipulate_layers(model_name, num_classes, device):
    ...
    last_4_convs = conv_layers[-4:]
    for conv in last_4_convs:
        for param in conv.parameters():
            param.requires_grad = True

    # Modify BatchNorm layers (optional)
    for module in fer.model.modules():
    ...
    fer.model.classifier = nn.Sequential(
        nn.BatchNorm1d(1280, momentum=0.1, eps=1e-5),
        nn.Linear(1280, 640),
        nn.ReLU(),
        nn.BatchNorm1d(640, momentum=0.1, eps=1e-5),
    ...
    # Log which layers are trainable or frozen
...
if __name__ == "__main__":
    ...
    torch.save(model.state_dict(), f'/home/diana/Documents/pth_reselection/emoreact_girls_4fc.pth')
    wandb.save(f'/home/diana/Documents/pth_reselection/emoreact_girls_4fc.pth')

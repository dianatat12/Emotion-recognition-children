...
# Initialize wandb
wandb.init(project="emoreact_girls_2fc", entity="dtat-universitat-oberta-de-catalunya")
...
if __name__ == "__main__":
    ...
    torch.save(model.state_dict(), f'/home/diana/Documents/pth_reselection/emoreact_girls_2fc.pth')
    wandb.save(f'/home/diana/Documents/pth_reselection/emoreact_girls_2fc.pth')
